def input_data():
    input_total_process = int(input('Enter the number of Processes: '))
    array = []
    sum_of_burst_time = 0
    index = []
    ...
    for x in range(0, input_total_process):
        ...
        burst_time = int(input('Enter burst time for ' + process_no + ': '))
        ...
        sum_arrayOf_single_process_wating_time.append(
            processNo_andItstotal_wating_time)
